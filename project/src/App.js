...
import ScoreboardDynamic from "./pages/Scoreboard/ScoreboardDynamic";
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/matches/:categoryId" element={<Matches />} />
          <Route path="/bracket/:categoryId" element={<Bracket />} />
          <Route path="/bracket-test" element={<BracketTest />} />
          <Route path="/bracket-tree-test" element={<BracketTreeTest />} />
