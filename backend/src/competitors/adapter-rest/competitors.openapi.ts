...
export const CompetitorsRoutes = {
    ...
    postBulk: createRoute({
        method: 'post',
        path: '/bulk',
        summary: 'Create multiple competitors',
        description: 'Create multiple competitors at once',
        request: {
            body: {
                content: {
                    "application/json": {
                        schema: z.array(CompetitorSchemaCreate)
                    }
                }
            }
        },
        responses: {
            201: {
                description: 'Competitors created successfully',
                content: {
                    'application/json': {
                        schema: z.object({
                            success: z.number(),
