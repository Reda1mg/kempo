...
export const TournamentsRoutes = {
    ...
    assignCompetitor: createRoute({
        method: 'post',
        path: '/{id}/categories/{categoryId}/competitors/{competitorId}/assign',
    ...
    getAllCompetitors: createRoute({
        method: 'get',
        path: '/{id}/categories/{categoryId}/competitors/all',
        summary: 'Get all available competitors for a category',
        description: 'Get all competitors that are available for assignment to a category',
        request: {
            params: z.object({
                id: z.string().uuid(),
                categoryId: z.string().uuid()
        ...
        responses: {
            200: {
                description: 'Available competitors',
                content: {
                    "application/json": {
    ...
    getAssignedCategoryCompetitors: createRoute({
        method: 'get',
        path: '/{id}/categories/{categoryId}/competitors',
        summary: 'Get competitors assigned to a category',
        description: 'Get all competitors assigned to a specific category',
        request: {
            params: z.object({
                id: z.string().uuid(),
                categoryId: z.string().uuid()
        ...
        responses: {
            200: {
                description: 'Competitors assigned to the category',
                content: {
                    'application/json': {
                        schema: z.array(z.object({
                            id: z.string(),
    ...
    removeCategoryCompetitor: createRoute({
        method: 'delete',
        path: '/{id}/categories/{categoryId}/competitors/{competitorId}',
        summary: 'Remove competitor from category',
        description: 'Remove a competitor from a specific category',
        request: {
            params: z.object({
                id: z.string().uuid(),
                categoryId: z.string().uuid(),
        ...
        responses: {
            200: {
                description: 'Competitor removed from category',
                content: {
                    'application/json': {
                        schema: z.object({
                            message: z.string()
            ...
            404: {
                description: 'Tournament, Category or Assignment not found',
                content: {
                    'application/json': {
                        schema: z.object({
                            message: z.string()
    ...
    resetTournament: createRoute({
        method: 'post',
        path: '/{id}/reset',
        summary: 'Reset the tournament',
        description: 'Reset the tournament by deleting all matches',
        request: {
            params: z.object({
                id: z.string().uuid()
            })
