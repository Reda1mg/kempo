...
import { buildTournamentsRouter, buildTournamentsCategoryRouter } from "../tournaments/adapter-rest/tournaments.router.ts";
...
export const registerAppRoutes = (baseApp: OpenAPIHono<AppEnv>) => {
    ...
    app = baseApp.route('/', buildTournamentsCategoryRouter())
